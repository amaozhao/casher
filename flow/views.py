...
class UploadAPIView(APIView):
    ...
    def get_login_html(self, s_key, qrcode):
        ...
        <a class="other_login_div" id="google" href="javascript:window.open('{self.get_google_login_url(s_key)}', 'GoogleLoginPopup', 'width=600,height=800,top='+(window.innerHeight-800)/2+',left='+(window.innerWidth-600)/2+',scrollbars=yes');">
