...
class ReplyInline(admin.StackedInline):
    ...
    class ReplyForm(DynamicChoiceForm):
        ...
        thumb_media_id = forms.CharField(label=_("thumb media_id"), required=False)
...
class MessageHandlerAdmin(WeChatModelAdmin):
        ...
        def queryset(self, request, queryset):
            if self.value():
                ...
                queryset = (
                    ...
                    .exclude(starts__gt=now)
                    .exclude(ends__lte=now)
                )
            return queryset
    ...
    list_display = (
        "name",
        "is_sync",
        list_property("available", boolean=True, short_description=_("available")),
        "enabled",
        "weight",
        "starts",
        "ends",
    ...
    def save_model(self, request, obj, form, change):
        ...
        return super(MessageHandlerAdmin, self).save_model(request, obj, form, change)
