...
from wechat_django.oauth import (
    WeChatAuthenticated,
    WeChatOAuthClient,
...
class OAuthAuthenticationTestCase(WeChatTestCase):
    def test_authentication(self):
        ...
        with mock.patch.object(WeChatApp, "auth"):
            ...
            self.assertEqual(request.session[request.wechat.session_key], openid)
    ...
    def test_model_auth(self):
        ...
        with mock.patch.object(WeChatOAuthClient, "fetch_access_token"):
            WeChatOAuthClient.fetch_access_token.return_value = dict(openid=openid)
        ...
        with mock.patch.object(
            WeChatOAuthClient, "fetch_access_token"
