...
class WeChatMessage(api.WeChatMessage):
    def send_articles(self, user_id, articles, account=None):
        try:
            return super(WeChatMessage, self).send_articles(user_id, articles, account)
...
class WeChatClient(_Client):
    ...
    def __init__(self, app):
        ...
        super(WeChatClient, self).__init__(app.appid, app.appsecret, session=session)
    ...
    def _request(self, method, url_or_endpoint, **kwargs):
        ...
        try:
            rv = super(WeChatClient, self)._request(method, url_or_endpoint, **kwargs)
