...
class WeChatModelMetaClass(m.base.ModelBase):
    def __new__(meta, name, bases, attrs):
        ...
        cls = super(WeChatModelMetaClass, meta).__new__(meta, name, bases, attrs)
        return cls
    ...
    def __init__(cls, name, bases, attrs):
        ...
        def shortcutmethod(method):
            ...
            rv.__qualname__ = "{0}.{1}".format(method._model.__name__, method_name)
            return rv
        ...
        for attr in attrs:
            ...
            if getattr(val, "_shortcutmethod", False):
                setattr(val._model, val._shortcutmethod, shortcutmethod(val))
