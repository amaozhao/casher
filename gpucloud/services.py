...
class GPUCloudService:
    ...
    def get_user_profile(self, user):
        ...
        if wx_user:
            ...
            unique_target = social_account.extra_data.get('unionid') or social_account.extra_data.get('email')
    ...
    def request_data(self, url, user, method, data):
        ...
        if method == 'get':
            response = request_method(urljoin(self.base_url, url), headers=headers, params=data)
            return response
